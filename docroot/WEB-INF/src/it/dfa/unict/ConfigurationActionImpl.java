...
public class ConfigurationActionImpl implements ConfigurationAction {
	...
	private void savePrefereces(ActionRequest actionRequest,
		...
		String fgHost = ParamUtil.getString(actionRequest, "fgHost", "");
		int fgPort = ParamUtil.getInteger(actionRequest, "fgPort");
		String fgAPIVersion = ParamUtil.getString(actionRequest,
				"fgAPIVersion", "");
		int applicationId = ParamUtil
				.getInteger(actionRequest, "applicationId");
